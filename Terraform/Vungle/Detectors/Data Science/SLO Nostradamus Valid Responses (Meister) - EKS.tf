# SLO Nostradamus Valid Responses (Meister) - EKS
resource "signalfx_detector" "slo_nostradamus_valid_responses_meister_eks" {
	name = "SLO Nostradamus Valid Responses (Meister) - EKS"
	description = "Nostradamus EKS SLO is not being met"
